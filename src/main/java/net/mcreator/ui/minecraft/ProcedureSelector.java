...
public class ProcedureSelector extends JPanel {
	...
	public ProcedureSelector(@Nullable IHelpContext helpContext, MCreator mcreator, String eventName, Side side,
		...
		if (side == Side.CLIENT) {
			...
			eventNameLabel.setToolTipText(L10N.t("dialog.procedure.trigger.triggers_on_client_side_only"));
			if (helpContext == null)
			...
			eventNameLabel.setToolTipText(L10N.t("dialog.procedure.trigger.triggers_on_server_side_only"));
